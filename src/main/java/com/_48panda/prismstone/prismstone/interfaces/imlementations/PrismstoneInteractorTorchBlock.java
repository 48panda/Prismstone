...
public abstract class PrismstoneInteractorTorchBlock extends TorchBlock implements IPrismstoneInteractor {
    
    public PrismstoneInteractorTorchBlock(Properties properties, ParticleOptions particleOptions) {
