...
public abstract class PrismstoneInteractorHorizontalDirectionalBlock extends HorizontalDirectionalBlock implements IPrismstoneInteractor {
    
    public PrismstoneInteractorHorizontalDirectionalBlock(Properties properties) {
        super(properties);
